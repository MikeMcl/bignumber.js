...
/*jshint eqnull: true, laxbreak: true, -W018 */

// gjslint fails if ; at beginning
(function ( global, privateUndefined ) {
    'use strict';
    ...
    */
    ...
    function bigNumberFactory() {
                ...
                if ( b != null ) {
                    ...
                    if ( ( b == (b | 0) || !ERRORS ) &&
                      !( outOfRange = !( b >= 2 && b < 65 ) ) ) {
                        ...
                        valid = new RegExp(  '^' + digits + '(?:\\.' + digits + ')?$', b < 37 ? 'i' : '' ).test(n);
                        if ( valid ) {
                    ...
                    /*jslint ass: false, bitwise: false */
                } else {
                    valid = isValid.test(n);
                }
        ...
        function inRange( n, lo, hi ) {
            outOfRange = n < lo || n > hi;
            return !( outOfRange || ( parse(n) != n && n !== 0 ) );
        }
        ...
        BigNumber['config'] = function () {
            ...
            if ( has( p ) ) {
                ...
                if ( inRange( v, -MAX, MAX ) ) {
                    TO_EXP_POS = toInt( v < 0 ? -v : +v );
                    TO_EXP_NEG = -TO_EXP_POS;
                } else if ( !outOfRange && v && inRange( v[0], -MAX, 0 ) &&
                  inRange( v[1], 0, MAX ) ) {
                    TO_EXP_NEG = toInt( v[0] );
                    TO_EXP_POS = toInt( v[1] );
                } else {
            ...
            if ( has( p ) ) {
                ...
                if ( inRange( v, -MAX, MAX ) && toInt( v ) ) {
                    MAX_EXP = toInt( v < 0 ? -v : +v );
                    MIN_EXP = -MAX_EXP;
        ...
        ifExceptionsThrow = function ( arg, i, j, isArray, isRange, isErrors) {
         ...
         */
        convert = function ( nStr, baseOut, baseIn, sign ) {
            ...
            function strToArr( str, bIn ) {
                ...
                for ( bIn = bIn || baseIn; i < strL; i++ ) {
                    ...
                    for ( arrL = arr.length, j = 0; j < arrL; j++ ) {
                        arr[j] *= bIn;
                    }
        ...
        divide = function ( dvd, dvs, exp, s, base, isOdd ) {
            ...
            for ( remL = rem.length ; remL < dvsL; remL++ ) {
                rem.push(0);
            }
            ...
            do {
                ...
                for ( next = 0; next < base; next++ ) {
                    ...
                    if ( dvsL != remL ) {
                        ...
                        for ( remI = 0, cmp = 0; remI < dvsL; remI++ ) {
        ...
        function format( n, d, exp ) {
             ...
             */
            if ( exp == 1 || ( exp == 2 && ( --d < i || i <= TO_EXP_NEG ) ) ) {
        ...
        rnd = function ( x, dp, base, isOdd, r ) {
            var xc = x['c'],
                isNeg = x['s'] < 0,
                half = base / 2,
                i = x['e'] + dp + 1,
        ...
        P['toPower'] = P['pow'] = function ( e ) {
            ...
            outOfRange = e < -MAX_POWER || e > MAX_POWER;
            if ( outOfRange ) {
                i = e * Infinity;
            }
        ...
        P['round'] = function ( dp, rm ) {
            ...
            if ( dp != null ) {
                outOfRange = dp < 0 || dp > MAX;
            }

            /*jslint bitwise: true */
            dp = dp == null || ( ( outOfRange ||
              parse(dp) != dp ) &&
            ...
            if ( rm != null ) {
                outOfRange = rm < 0 || rm > 8;
            }

            /*jslint bitwise: true */
            rm = rm == null || ( ( outOfRange ||
        ...
        P['squareRoot'] = P['sqrt'] = function () {
            ...
            if ( s === 0 || s == Infinity ) {
                ...
                r = new BigNumber( String( Math.sqrt(n) ) );
        ...
        P['toPrecision'] = P['toP'] = function ( sd ) {
             ...
             */
            if ( sd != null ) {
                outOfRange = sd < 1 || sd > MAX;
            }

            return sd == null || ( ( outOfRange || parse(sd) != sd ) &&
    ...
    var BigNumber = bigNumberFactory();

    BigNumber['anew'] = function () {
